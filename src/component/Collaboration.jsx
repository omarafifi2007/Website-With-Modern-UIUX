        ...
        <Section crosses>
            <div className="container lg-flex">
                <div className="max-w-[25rem]">
                    ...
                    <Button className="A">Try It Now</Button>
                </div>
                <div className="lg:ml-auto xl:w-[38rem] mt-5">
                    ...
                    <div id="P" className="relative left-auto flex w-[22rem] aspect-square border border-n-6 rounded-full translate-x-1/2 scale-75 md:scale-100">
                        <div className="flex w-60 aspect-square m-auto border-n-6 rounded-full">
                            <div className="w-[6rem] aspect-square m-auto p-[0.2rem] bg-conic-gradient rounded-full">
                                <div className="flex items-center justify-center w-full h-full bg-n-8 rounded-full">
                                    <img src={brainwaveSymbol} width={100} height={100} alt="BrainWave" />
                                </div>
                            </div>
                        </div>
                        <ul>
                            {collabApps.map((app, index) => (
                                <li key={app.id} className={`absolute top-0 left-[40%] h-1/2 ml-[1.6rem] origin-bottom rotate-${index * 45}`}>
